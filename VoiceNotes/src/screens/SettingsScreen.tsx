...
const MIC_SOURCES = [
  {
    value: 1,
    label: 'Несколько спикеров / Совещание',
    desc: 'Записывает всех, кто говорит в комнате. Используй для переговоров, лекций, интервью.',
    icon: '◎',
  },
  {
    value: 6,
    label: 'Один спикер (свой голос)',
    desc: 'Оптимизирован под один голос, подавляет фоновый шум. Лучше для личных заметок.',
    icon: '○',
  },
  {
    value: 7,
